 ...
 *
 * Frontend-only repo adaptation:
 *  - (기존) frontend/ 경로만 diff 추출 → (변경) 레포 전체에서 reviewable 파일만 추출
 *  - 워크플로우의 paths-filter와 동일하게 문서/빌드 산출물/커버리지/락파일은 제외
 *
