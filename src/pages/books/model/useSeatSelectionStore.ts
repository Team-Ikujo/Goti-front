...
type SeatSelectionStore = {
   ...
   initializeZone: (zoneId: string, seats: SeatItem[]) => void;
   toggleSelectedSeat: (zoneId: string, seatId: string) => void;
   clearSelection: (zoneId: string) => void;
   clearAllSelections: () => void;
   applyServerSeatPatch: (zoneId: string, seatId: string, status: SeatStatus) => void;
   applyServerSeatSnapshot: (zoneId: string, seats: SeatItem[]) => void;
};

const createZoneState = (seats: SeatItem[]): ZoneSeatState => ({
...
const isSelectableStatus = (status: SeatStatus) => status === 'available' || status === 'selected';
