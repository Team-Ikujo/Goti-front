...
export const PURCHASE_DETAIL_MAP: Record<string, PurchaseDetailData> = {
   ...
   // ── 추가 테스트 케이스 ──────────────────────────────────────
   // 20: 예매 완료 + 무통장 완료 + 모바일 QR
   '20': {
      id: '20',
      orderId: 'GT0921983209020',
      orderDate: '2026.03.25',
      overallStatus: '예매 완료',
      game: { teams: 'SSG vs 두산', venue: '인천', datetime: '2026.04.02 (목) 18:30' },
      orderer: '홍길동',
      cancelDeadline: '2026.04.02 (목) 14:30 까지',
      seatItems: [
         {
            orderId: 'ORD2603250020-1',
            section: '3루 외야 지정석',
            seatDetail: '402구역 3열 11번',
            status: '예매완료',
            price: 13000,
         },
         {
            orderId: 'ORD2603250020-2',
            section: '3루 외야 지정석',
            seatDetail: '402구역 3열 12번',
            status: '예매완료',
            price: 13000,
         },
      ],
      ...
      paymentSummary: {
         ...
         fee: 1040,
         total: 27040,
         date: '2026.03.25 (수) 17:30',
         status: '결제 완료',
         bankAccount: 'NH농협 302-0000-0000-00 (고티(주))',
      },
      paymentEvents: [],
      canCancel: true,
      canSell: false,
   },
   // 21: 예매 완료 + 무통장 완료 + 현장수령
   '21': {
      id: '21',
      orderId: 'GT0921983209021',
      orderDate: '2026.03.23',
      overallStatus: '예매 완료',
      game: { teams: 'KT vs 삼성', venue: '수원', datetime: '2026.04.01 (수) 18:30' },
      orderer: '홍길동',
      cancelDeadline: '2026.04.01 (수) 14:30 까지',
      seatItems: [
         {
            orderId: 'ORD2603230021-1',
            section: '내야 지정석 A',
            seatDetail: '107구역 5열 8번',
            status: '예매완료',
            price: 17000,
         },
      ],
   ...
   // 22: 취소/환불 + 무통장 환불 + 모바일 QR
   '22': {
      id: '22',
      orderId: 'GT0921983209022',
      orderDate: '2026.03.18',
      overallStatus: '취소/환불',
      game: { teams: '키움 vs 롯데', venue: '고척', datetime: '2026.03.25 (수) 18:30' },
      orderer: '홍길동',
      cancelDate: '2026.03.20 (금) 09:00',
      seatItems: [
         {
            orderId: 'ORD2603180022-1',
            section: '외야 지정석',
            seatDetail: '401구역 8열 5번',
            status: '취소완료',
            price: 13000,
         },
         {
            orderId: 'ORD2603180022-2',
            section: '외야 지정석',
            seatDetail: '401구역 8열 6번',
            status: '취소완료',
            price: 13000,
         },
      ],
      ...
      refundInfo: {
         ...
         cancelFee: -1000,
         refundTotal: 25000,
         method: '우리 1234-567-890123 (홍길동)',
         date: '2026.03.20 (금) 09:00',
         bankAccount: '우리 1234-567-890123 (홍길동)',
      },
      canCancel: false,
      canSell: false,
   },
   ...
   '16': {
      id: '16',
      orderId: 'GT0921983209016',
      orderDate: '2026.03.26',
      overallStatus: '입금 대기',
      game: { teams: 'LG vs 키움', venue: '잠실', datetime: '2026.04.05 (토) 14:00' },
      orderer: '홍길동',
      cancelDeadline: '2026.03.28 (토) 23:59 까지',
      seatItems: [
         {
            orderId: 'ORD2603260016-1',
            section: '1루 K8석',
            seatDetail: '110구역 7열 3번',
            status: '예매완료',
            price: 16000,
         },
         {
            orderId: 'ORD2603260016-2',
            section: '1루 K8석',
            seatDetail: '110구역 7열 4번',
            status: '예매완료',
            price: 16000,
         },
      ],
      ...
      paymentSummary: {
         ...
         fee: 1280,
         total: 33280,
         date: '2026.03.26 (목) 22:10',
         status: '입금 대기',
         bankAccount: 'NH농협 302-0000-0000-00 (고티(주))',
         bankDeadline: '2026.03.28 (토) 23:59 까지',
      },
      paymentEvents: [],
      canCancel: false,
      canSell: false,
   ...
   '17': {
      id: '17',
      orderId: 'GT0921983209017',
      orderDate: '2026.03.24',
      overallStatus: '예매 완료',
      game: { teams: '한화 vs KT', venue: '대전', datetime: '2026.03.30 (일) 18:30' },
      orderer: '홍길동',
      cancelDeadline: '2026.03.30 (일) 14:30 까지',
      seatItems: [
         {
            orderId: 'ORD2603240017-1',
            section: '내야 지정석 A',
            seatDetail: '104구역 2열 11번',
            status: '예매완료',
            price: 18000,
         },
      ],
      deliveryMethod: '배송',
      deliveryAddress: '서울특별시 마포구 월드컵북로 400',
      deliveryStatus: '배송 준비 중',
      deliveryCarrier: 'CJ대한통운',
      deliveryTrackingNumber: '555555555555',
      paymentSummary: {
         ticketCount: 1,
         ticketAmount: 18000,
         fee: 720,
         total: 18720,
         date: '2026.03.24 (월) 09:11',
         status: '결제 완료',
      },
      paymentEvents: [
         {
            ...
            date: '2026.03.24 (월) 09:11',
            items: [
               { label: '티켓 금액 (1매)', amount: 18000 },
               { label: '수수료', amount: 720 },
            ],
            totalLabel: '총 결제 금액',
            totalAmount: 18720,
            methodLabel: '결제 수단',
   ...
   '18': {
      id: '18',
      orderId: 'GT0921983209018',
      orderDate: '2026.03.10',
      overallStatus: '취소/환불',
      game: { teams: '롯데 vs NC', venue: '사직', datetime: '2026.03.17 (월) 18:30' },
      orderer: '홍길동',
      cancelDate: '2026.03.12 (목) 14:30',
      seatItems: [
         {
            orderId: 'ORD2603100018-1',
            section: '3루 K9석',
            seatDetail: '208구역 4열 6번',
            status: '취소완료',
            price: 14000,
         },
         {
            orderId: 'ORD2603100018-2',
            section: '3루 K9석',
            seatDetail: '208구역 4열 7번',
            status: '취소완료',
            price: 14000,
         },
      ],
      deliveryMethod: '배송',
      deliveryAddress: '부산광역시 해운대구 센텀중앙로 55',
      deliveryStatus: '배송 취소',
      deliveryCarrier: 'CJ대한통운',
      deliveryTrackingNumber: '666666666666',
      paymentSummary: {
         ticketCount: 2,
         ticketAmount: 28000,
         fee: 1120,
         total: 29120,
         date: '2026.03.10 (화) 10:00',
         status: '취소/환불',
      },
      paymentEvents: [],
      refundInfo: {
   ...
   '19': {
      id: '19',
      orderId: 'GT0921983209019',
      orderDate: '2026.03.05',
      overallStatus: '관람 완료',
      game: { teams: 'KIA vs 삼성', venue: '광주', datetime: '2026.03.12 (수) 17:00' },
      orderer: '홍길동',
      seatItems: [
         {
            orderId: 'ORD2603050019-1',
            section: '1루 지정석',
            seatDetail: '106구역 3열 9번',
            status: '예매완료',
            price: 17000,
         },
         {
            orderId: 'ORD2603050019-2',
            section: '1루 지정석',
            seatDetail: '106구역 3열 10번',
            status: '예매완료',
            price: 17000,
         },
      ],
      deliveryMethod: '배송',
      deliveryAddress: '대구광역시 수성구 동대구로 123',
      deliveryStatus: '배송 완료',
      deliveryCarrier: 'CJ대한통운',
      deliveryTrackingNumber: '777777777777',
      paymentSummary: {
         ticketCount: 2,
         ticketAmount: 34000,
         fee: 1360,
         total: 35360,
         date: '2026.03.05 (목) 16:45',
         status: '결제 완료',
      },
      paymentEvents: [
         {
            ...
            date: '2026.03.05 (목) 16:45',
            items: [
               { label: '티켓 금액 (2매)', amount: 34000 },
               { label: '수수료', amount: 1360 },
            ],
            totalLabel: '총 결제 금액',
            totalAmount: 35360,
            methodLabel: '결제 수단',
